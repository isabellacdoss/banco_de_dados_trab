...
-- Inserindo dados na Pessoa Juridica:
...
INSERT INTO administracao(CPF_fun, valorempresa, valorfuncionario) VALUES
...
-- inserindo valores em CNPJ de administracao:
update administracao
set CNPJ_adm = (select CNPJ_empresa from funcionario where funcionario.CPF_fun = administracao.CPF_fun);
-- inserindo valores em codfundo de administracao:
update administracao
set codFundo = (select codFundo from fundopensao where fundopensao.CNPJ_pj = administracao.CNPJ_adm);
